...
class UserRobHistory extends Component {
    static navigationOptions = {
        header: null,
        drawerLabel: 'My Posts',
        drawerIcon: ({ tintColor }) => <MaterialIcons name="history" size={24} color={tintColor} />
    };
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchData() {
        ...
        fire.database().ref(`usersAlerts/${userId}/`).once("value", function (snapshot) {
